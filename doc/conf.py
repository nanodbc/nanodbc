...
project = 'nanodbc'
copyright = '2016-2012, Amy Troschinetz and others.'
...
latex_documents = [
    (master_doc, 'nanodbc.tex', 'nanodbc Documentation',
     'Amy', 'manual'),
]
...
man_pages = [
    (master_doc, 'nanodbc', 'nanodbc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nanodbc', 'nanodbc Documentation',
     author, 'nanodbc', 'One line description of project.',
     'Miscellaneous'),
]
